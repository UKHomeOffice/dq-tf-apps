...
class TestE2E(unittest.TestCase):
    ...
    #     self.assertEqual(self.runner.get_value("module.apps.aws_ssm_parameter.drt_export_id", "name"), "DRT_AWS_ACCESS_KEY_ID")
    #
    # def test_name_drt_export_ssm_iam_user_key(self):
    #     self.assertEqual(self.runner.get_value("module.apps.aws_ssm_parameter.drt_export_key", "name"), "DRT_AWS_SECRET_ACCESS_KEY")
