...
class TestE2E(unittest.TestCase):
    ...
    def test_name_oag_iam_policy(self):
        self.assertEqual(self.runner.get_value("module.apps.aws_iam_policy.oag", "name"), "iam-policy-oag-apps-preprod-dq")
    ...
    def test_name_athena_iam_policy(self):
        self.assertEqual(self.runner.get_value("module.apps.aws_iam_policy.athena", "name"), "iam-policy-athena-apps-preprod-dq")
    ...
    def test_name_dq_data_generator_bucket_iam_policy(self):
       self.assertEqual(self.runner.get_value("module.apps.aws_iam_policy.dq_data_generator_bucket", "name"), "dq_data_generator_bucket_policy")
