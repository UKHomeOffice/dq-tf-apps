...
class TestE2E(unittest.TestCase):
    ...
    def test_name_suffix_cdlz_bitd_input_pipeline_iam_bitd_input(self):
        self.assertEqual(self.result['apps']['cdlz_bitd_input']["aws_iam_role.bitd_role"]["tags.Name"], "iam-bitd-input-apps-preprod-dq")
    ...
    def test_name_suffix_cdlz_bitd_input_pipeline_lambda_bitd_input(self):
        self.assertEqual(self.result['apps']['cdlz_bitd_input']["aws_lambda_function.bitd_input"]["tags.Name"], "bitd-input-apps-preprod-dq")

    def test_name_suffix_cdlz_bitd_input_pipeline_lambda_createdb_resources(self):
        self.assertEqual(self.result['apps']['cdlz_bitd_input']["aws_lambda_function.createdb_resources"]["tags.Name"], "createdb-resources-apps-preprod-dq")
